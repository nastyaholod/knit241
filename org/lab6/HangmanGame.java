...
public class HangmanGame {
    ...
    private static List<String> getWords() {
        return Arrays.asList(
                "море", "компьютер", "программирование", "java", "игра", "виселица", "алгоритм", "доска", "код",
                "учебник"
        );
    }
    ...
    // Конструктор класса
    public HangmanGame() {
        Collections.shuffle(words); // Перемешивание списка слов
        List<String> gameWords = new ArrayList<>(); // Список подходящих слов для игры

        // Выбор слов длиной более 3 символов
        for (String w : words) {
            if (w.length() > 3) {
                gameWords.add(w);
            }
        ...
        // Случайный выбор слова из списка подходящих
